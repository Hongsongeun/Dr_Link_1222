...
<script type="text/javascript">
	$(document).ready(function(){
		$(".chat-cont-right").hide();
		
		$(".chat-scroll > a").each(function(){
			$(this).click(function(){
				$(".chat-scroll > a").attr('class','media');
				$(this).attr('class','media read-chat active');
		...
		let sock = new SockJS("http://localhost:8000/00_test/test");
		...
		function sendMessage() {
			var option = {
				From : $('.From').val(),
				To : $('.media.read-chat.active').find('div.media-body').find('div:eq(0)').find('div.user-name').text(),
				MSG : $(".input-msg-send.form-control").val()
			};
			var data = $(".input-msg-send.form-control").val();
		...
		function onMessage(msg) {
			...
			$("#messageArea").append(d.From + ": " + d.MSG + "<br/>");
					...
					<li class="nav-item dropdown has-arrow logged-item"><a
						href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"> <img class="rounded-circle"
								src="${path}/resources/assets/img/doctors/doctor-thumb-02.jpg"
										...
										<c:forEach var="doctor" items="${doctor_list}" varStatus="i">											
											<a href="javascript:void(0);" class="media">
												...
												<div class="media-body">
													<div>
														<div class="user-name">${doctor.doctor_name }</div>
														<div class="user-last-chat">Hey, How are you?</div>
													</div>
													<div>
														<div class="last-chat-time block">${doctor.dept.dept_name }</div>
													</div>
												</div>
											</a>
										</c:forEach>
									...
									<div class="media">
										<div class="media-img-wrap">
											<div class="avatar avatar-online">
												<img src="${path}/resources/assets/img/patients/patient.jpg"
													alt="User Image" class="avatar-img rounded-circle">
											</div>
										</div>
										<div class="media-body">
														...
														<div>
															<div class="chat-msg-attachments">
																<div class="chat-attachment">
																	<img src="${path}/resources/assets/img/img-02.jpg"
																		alt="Attachment">
																	<div class="chat-attach-caption">placeholder.jpg</div>
																	<a href="" class="chat-attach-download"> <i
																		class="fas fa-download"></i>
																	</a>
																</div>
																<div class="chat-attachment">
																	<img src="${path}/resources/assets/img/img-03.jpg"
																		alt="Attachment">
																	<div class="chat-attach-caption">placeholder.jpg</div>
																	<a href="" class="chat-attach-download"> <i
																		class="fas fa-download"></i>
												...
												<div class="media-body">
													...
													<div class="msg-box">
														<div>
															<div class="chat-msg-attachments">
																<div class="chat-attachment">
																	<img src="${path}/resources/assets/img/img-04.jpg"
																		alt="Attachment">
																	<div class="chat-attach-caption">placeholder.jpg</div>
																	<a href="" class="chat-attach-download"> <i
																		class="fas fa-download"></i>
														...
														<div>
															...
															<div class="chat-msg-actions dropdown">
																<a href="#" data-toggle="dropdown" aria-haspopup="true"
																	aria-expanded="false"> <i class="fe fe-elipsis-v"></i>
																</a>
																<div class="dropdown-menu dropdown-menu-right">
