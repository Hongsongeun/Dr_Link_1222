				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-9 m-auto">
							...
							<div class="row ">
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										<img src="${path}/resources/assets/img/eyeRight1.jpg" alt="" class="img-fluid" >
								...
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										<img src="${path}/resources/assets/img/eyeError1.jpg"  alt="" class="img-fluid" >
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
								...
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										<img src="${path}/resources/assets/img/eyeError2.jpg" alt="" class="img-fluid" >
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
											<h3 class="card-title mb-0">틀린 사진</h3>
											</div>
							...
							<form class="file-input-frm" action="aiTest" method="post" enctype="multipart/form-data">
