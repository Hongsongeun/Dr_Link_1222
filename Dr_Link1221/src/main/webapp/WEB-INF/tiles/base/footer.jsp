				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="footer-widget footer-menu">
							...
							<h2 class="footer-title"><a href="health-care" class="footer-menu">FAQ</a></h2>
							<h2 class="footer-title"><a href="health-care" class="footer-menu">오시는 길</a></h2>
						</div>
						<!-- /Footer Widget -->
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="footer-widget footer-menu">
							...
							<ul>
								<li><a href="login">안과 진단</a></li>
								<li><a href="login">피부과 진단</a></li>
								<li><a href="login">정신과 진단</a></li>
							</ul>
						</div>
						<!-- /Footer Widget -->
...
<!-- Slick JS -->
<script src="${path}/resources/js/slick.js"></script>
