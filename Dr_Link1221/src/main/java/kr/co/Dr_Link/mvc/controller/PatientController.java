...
import kr.co.Dr_Link.mvc.dto.TreatRecordDTO1;
...
public class PatientController {
	...
	public String treatmentRecord(TreatRecordDTO1 vo, Model model) {
		List<TreatRecordDTO1> treatmentRecord = patient_dao.treatmentRecord(vo);
